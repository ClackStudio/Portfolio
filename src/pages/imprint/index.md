...
This gives us certain data such. IP address, browser used and operating system.\
...
Mozilla Firefox: https://support.mozilla.org/en/kb/cookies-lodging-data-from-websites-\
...
The recipient of the data is Google as a processor. For this we have concluded with Google the corresponding order processing contract.

STORAGE TIME

The deletion of the data takes place as soon as they are no longer necessary for our recording purposes.
