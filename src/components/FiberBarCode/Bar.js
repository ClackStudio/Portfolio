...
import { useBarCodeStore, useBackgroundStore, numberOfBars } from "./../../stores/BarCodeStore";
...
const Bar = ({width, index, height, position, scale, map, barCodePatternProps,  ...props }) => {
